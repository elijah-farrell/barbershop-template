...
export default function HeroSection({ onBookingOpen }: HeroSectionProps) {
  ...
  const images = [
    "https://placehold.co/800x600/8B4513/FFFFFF?text=Classic+Cuts",
    "https://placehold.co/800x600/654321/FFFFFF?text=Modern+Styles",
    "https://placehold.co/800x600/A0522D/FFFFFF?text=Beard+Trim",
  ];
  ...
  return (
    <section
      id="home"
      className="pt-16 min-h-screen flex items-center bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a]"
    >
      <div className="max-w-7xl mx-auto px-4 max-sm:px-2 grid grid-cols-2 max-lg:grid-cols-1 gap-12 max-lg:gap-8 items-center">
        <div className="max-lg:order-2">
          <h1 className="text-5xl max-lg:text-4xl max-sm:text-3xl font-bold text-[#fff] mb-6 leading-tight">
            ...
            <span className="text-[#d4af37]">Watertown</span>
          </h1>
          <p className="text-xl max-sm:text-lg text-[#ccc] mb-8 leading-relaxed">
            ...
            Serving Northern New York with precision cuts, classic shaves, and
        ...
        <div className="max-lg:order-1 relative">
          <div className="relative overflow-hidden rounded-2xl shadow-2xl">
            <img
              ...
              className="w-full h-[600px] max-lg:h-[400px] object-cover transition-all duration-500"
          ...
          <button
            onClick={prevImage}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-[#000] bg-opacity-50 text-[#fff] p-3 rounded-full transition-all duration-200 hover:bg-opacity-75"
          >
            <svg
              className="w-6 h-6"
              fill="none"
          ...
          <button
            onClick={nextImage}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-[#000] bg-opacity-50 text-[#fff] p-3 rounded-full transition-all duration-200 hover:bg-opacity-75"
          >
            <svg
              className="w-6 h-6"
              fill="none"
